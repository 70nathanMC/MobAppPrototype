    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnCreateMeeting.setOnClickListener {
            ...
            if (subject.isBlank() || branch.isBlank() || day.isBlank() ||
                ...
                val builder = AlertDialog.Builder(this) // 'this' should be the Activity or Fragment context
                builder.setTitle("Disclaimer for Tutors")
                builder.setMessage(
                    """
    By creating this meeting, you acknowledge and agree to the following:

    *   Professional Conduct: Maintain a professional demeanor throughout the meeting. Be punctual, prepared, and focused on providing a positive learning experience.
    *   Respectful Communication: All interactions with students should be courteous and respectful. Avoid any language or behavior that could be considered offensive, discriminatory, or harassing.
    *   Privacy: Respect the privacy of your students. Do not share their personal information or meeting content outside of the session without their consent.
    *   Confidentiality:  Any materials you share during the meeting are for educational purposes and should not be distributed or reproduced without your permission.
    *   Appropriate Content: The content of your meeting should be suitable for the educational level and age of the students. Avoid any inappropriate or offensive material.
    *   In-Person Meetings: If you choose to meet with students in person, you do so at your own risk. We are not responsible for any incidents or issues that may occur during such meetings. Please exercise caution and good judgment when arranging and attending in-person sessions. It is recommended to meet in safe, public locations.
    *   Platform Policies: Adhere to all platform policies and guidelines, including those related to scheduling, cancellations, and payments.

    Failure to adhere to these guidelines may result in removal from the platform and/or further consequences as determined by the platform administrators.
    """.trimIndent()
                )
                        ...
                        userRef.get().addOnSuccessListener { documentSnapshot ->
                            if (documentSnapshot.exists()) {
                                ...
                                val meetingData = hashMapOf(
                                    ...
                                    "startTimeTimestamp" to com.google.firebase.Timestamp(
                                        startTimeCalendar.time
                                    ),
                                    "endTimeTimestamp" to com.google.firebase.Timestamp(
                                ...
                                db.collection("meetings")
                                    ...
                                    .addOnSuccessListener { documentReference ->
                                        Toast.makeText(this, "Meeting created!", Toast.LENGTH_SHORT)
                                            .show()
                                        ...
                                        db.collection("users").document(userId)
                                            ...
                                            .addOnSuccessListener {
                                                Log.d(
                                                    ...
                                                    "Meeting ID added to tutor's document: $meetingId"
                                                )
                                                db.collection("subjects")
                                                    ...
                                                    .addOnSuccessListener { subjectDocuments ->
                                                        if (!subjectDocuments.isEmpty) {
                                                            val subjectDocument =
                                                                subjectDocuments.first() // Get the first document with the matching subjectName
                                                            subjectDocument.reference.update(
                                                                "relatedTutors",
                                                                ...
                                                                .addOnSuccessListener {
                                                                    Log.d(
                                                                        TAG,
                                                                        "Tutor $userId added to subject $subject"
                                                                    )
                                                                    finish()
                                                                }
                                                                .addOnFailureListener { e ->
                                                                    Log.w(
                                                                        TAG,
                                                                        "Error adding tutor to subject: ${e.message}"
                                                                    )
                                                                    Toast.makeText(
                                                                        this,
                                                                        "Error adding tutor to subject: ${e.message}",
                                                            ...
                                                            Log.w(
                                                                TAG,
                                                                "Subject document not found for $subject"
                                                            )
                                                            Toast.makeText(
                                                                this,
                                                                "Subject document not found for $subject",
                                                    ...
                                                    .addOnFailureListener { e ->
                                                        Log.w(
                                                            TAG,
                                                            "Error fetching subject document: ${e.message}"
                                                        )
                                                        Toast.makeText(
                                                            this,
                                                            "Error fetching subject document: ${e.message}",
                                            ...
                                            .addOnFailureListener { e ->
                                                Toast.makeText(
                                                    this,
                                                    "Error updating tutor's meetings: ${e.message}",
                                                    Toast.LENGTH_SHORT
                                                ).show()
                                                Log.d(
                                                    TAG,
